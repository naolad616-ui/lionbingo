export function ProfileUserIcon({ className = 'h-4 w-4' }) {
  return (
...
export function ProfileSettingsIcon({ className = 'h-4 w-4' }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
export function ProfileLogoutIcon({ className = 'h-4 w-4' }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <path strokeLinecap="round" d="M12 3v8" />
      <path strokeLinecap="round" d="M7.5 6.2A6.5 6.5 0 1 0 16.5 6.2" />
    </svg>
  );
}
